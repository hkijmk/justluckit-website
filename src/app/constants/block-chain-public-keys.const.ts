...
export const BLOCK_CHAIN_KEYS = {
    ...
    record: new PublicKey('7JJurLjM2PnZGDt7TtsyawobZejV5VcDxVz6FJ8ScySE'),
    term: new PublicKey('2zpLySmhPWmjeof8KNeHmmXQJiWQYQFa26JnpFtNAZ1G'),
    minerTerms: new PublicKey('87BywfRdwL4GmTsGptWGv4AaPs3um1Vp5jdAX8HJs73F'),
